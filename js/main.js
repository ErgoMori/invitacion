;(function () {
    ...
    // Scroll hacia secciones del menú (funciona en móvil y desktop)
    var smoothScrollMenu = function() {
        $('body').on('click', '.fh5co-nav a[href^="#"], #fh5co-offcanvas a[href^="#"]', function(e) {
            e.preventDefault();
            ...
            // Cerrar menú offcanvas si estaba abierto
            $('body').removeClass('overflow offcanvas');
            $('.js-fh5co-nav-toggle').removeClass('active');
        });
    };
    ...
    $(function(){
        ...
        offcanvasMenu();
        burgerMenu();
        smoothScrollMenu(); // <-- agregamos scroll suave
        contentWayPoint();
        dropdown();
        testimonialCarousel();
        goToTop();
